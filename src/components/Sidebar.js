    ...
    <>
      ...
      `}>
        ...
        <ul className="py-4">
          ...
          <li>
            <Link to="/customer-receipt-template" className="flex items-center px-4 py-2 text-gray-800 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700" onClick={onClose}>
